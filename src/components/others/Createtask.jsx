...
const Createtask=({data})=>{
    ...
    return(
        <div className="p-5 bg-[#1c1c1c] mt-7 rounded">
                <form className=" p-5 flex w-full items-start justify-between">
                    <div className="w-1/2"> 
                        <div>
                    ...
                    <div className="w-2/5 flex flex-col items-start">
                        ...
                        <button className="bg-emerald-500 hover:bg-emerald-700 px-5 rounded text-sm mt-4 h-10 w-full">Create Task</button>
                    </div>
